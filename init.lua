...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["<M-1>"] = { "<cmd>Neotree toggle<cr>", desc = "Toggle Explorer" },
    ...
    v = {
      ...
      ["s"] = { ":'<,'>BrowserSearch<CR>", desc = "Search on web" },
    },
    t = {
  ...
  plugins = {
    ...
    ["mason-lspconfig"] = { -- overrides `require("mason-lspconfig").setup(...)`
      ensure_installed = { "sumneko_lua", "angularls", "arduino_language_server", "cssls", "tsserver", "yamlls" },
    },
    -- use mason-null-ls to configure Formatters/Linter installation for null-ls sources
    ["mason-null-ls"] = { -- overrides `require("mason-null-ls").setup(...)`
      ensure_installed = { "prettier", "stylua", "ccls", "clang_format", "eslint_d", "luacheck" },
    },
  },
